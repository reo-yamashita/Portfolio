...
export type FileFieldsEnum = 
  ...
  | 'childMdx___frontmatter___learning_Point'
...
export type MdxFrontmatter = {
  ...
  learning_Point?: Maybe<Array<Maybe<Scalars['String']>>>;
...
export type MdxFrontmatterFilterInput = {
  ...
  learning_Point?: Maybe<StringQueryOperatorInput>;
...
export type SiteSiteMetadataSocial = {
  ...
  qitta?: Maybe<Scalars['String']>;
};

export type SiteSiteMetadataSocialFilterInput = {
  twitter?: Maybe<StringQueryOperatorInput>;
  github?: Maybe<StringQueryOperatorInput>;
  qitta?: Maybe<StringQueryOperatorInput>;
};
...
export type SeoQuery = { site?: Maybe<(
    Pick<Site, 'buildTime'>
    & { siteMetadata?: Maybe<(
      Pick<SiteSiteMetadata, 'titleAlt' | 'shortName' | 'author' | 'siteLanguage' | 'logo' | 'pathPrefix'>
...
export type ImageQuery = { site?: Maybe<{ siteMetadata?: Maybe<(
      Pick<SiteSiteMetadata, 'title' | 'description' | 'author'>
      & { social?: Maybe<Pick<SiteSiteMetadataSocial, 'twitter' | 'github' | 'qitta'>> }
    )> }> };

export type CategorizedPostsQueryVariables = Exact<{ [key: string]: never; }>;


export type CategorizedPostsQuery = { categorized: { group: Array<{ category: MdxGroupConnection['fieldValue'] }> } };

export type AllPostsQueryVariables = Exact<{ [key: string]: never; }>;

///////gatsby-node.ts
export type AllNodeTypeQuery = { allPosts: { edges: Array<{ previous?: Maybe<{ frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'date'>>, fields?: Maybe<Pick<MdxFields, 'slug'>> }>, next?: Maybe<{ frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'date'>>, fields?: Maybe<Pick<MdxFields, 'slug'>> }>, node: { fields?: Maybe<Pick<MdxFields, 'slug'>> } }> }, groups: { group: Array<{ tags: MdxGroupConnection['fieldValue'] }> } };


export type AllPostsQuery = { allPosts: { edges: Array<{ node: (
        Pick<Mdx, 'excerpt'>
        & { frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'date' | 'learning_Point' | 'tags'>>, fields?: Maybe<Pick<MdxFields, 'slug'>> }
      ) }> } };
...
export type ArticleQuery = { post?: Maybe<(
    Pick<Mdx, 'body'>
    & { fields?: Maybe<Pick<MdxFields, 'slug'>>, frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'date' | 'learning_Point'>> }
  )> };

export type TagsPostsQueryVariables = Exact<{
  tags: Scalars['String'];
}>;


export type TagsPostsQuery = { allPosts: { edges: Array<{ node: (
        Pick<Mdx, 'excerpt'>
        & { frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'date' | 'learning_Point' | 'tags'>>, fields?: Maybe<Pick<MdxFields, 'slug'>> }
      ) }> } };
