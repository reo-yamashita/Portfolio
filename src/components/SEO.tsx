...
import { TypeSEO } from '@@/allTypes/gatsby-type';

const SEO: React.FC<TypeSEO> = ({ title, desc, pathname, article }) => (
  <StaticQuery
    query={query}
    render={({
      site: {
      ...
      let schemaOrgJSONLD: TypeSchemaOrgJSONLD = [
        {
