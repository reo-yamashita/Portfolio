...
const Myself = () => {
  ...
  const Interesting = [
    {title:'日向坂46',color: 'bg-blue-400'},
    {title:'クラシック音楽',color: 'bg-red-400'},
    {title:'ヴァイオリン',color: 'bg-purple-500'}
  ]
  ...
  <Layout>
    ...
    <div className="pt-12 w-full">
      <div className="w-full sm:w-10/12  mx-auto px-4 md:pl-40 md:pr-8 md:pb-6 max-w-6xl">
        <h2 className="text-3xl md:text-4xl font-extrabold tracking-wide text-lightblue-800">About me</h2>
      </div>
    </div> 
    <div className="pt-4">
        ...
        <div className="mb-24 fadeIn_animation mx-auto">
          <div className="pt-4 flex">
            <div className="max-w-sm  flex-grow">
              ...
              hover:bg-indigo-600 hover:text-gray-50 inline-block rounded-lg">
                <a href="https://github.com/NearString/ts-blog/tree/main"  target="_blank"  rel="noopener noreferrer">
              ...
              <div className="mt-6 pr-6 tracking-wide fontpalt">
                <ul className=" flex flex-wrap">
                  {Interesting.map( (item) => {
                    return(
                      <li  key={`${item.title}`} className={`select-none tracking-widest fontpalt m-1 text-base rounded-md px-3 py-1 ${item.color} text-gray-100 font-normal`}>
                        {item.title}
                      </li>
                  )})}
                </ul>
